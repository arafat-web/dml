            ...
            <div class="row">
                <div class="col-lg-3 width-23 mb-30">
                    ...
                    <p class="font-xs mb-20 color-white">We fuse our global network with our depth of expertise in
                        ...
                        providing
                        sourcing, warehousing, E-commercial fulfillment, and value-added service to our customers
                        including
                        kitting, assembly, customized package and business inserts, etc.</p>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 text-center text-lg-end">
                        <ul class="menu-bottom">
                            ...
                            <li><a class="font-sm color-grey-300" href="term-conditions.html">Terms of
                                    service</a></li>
                        </ul>
                    </div>
                </div>
