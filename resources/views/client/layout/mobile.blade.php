            ...
            <div class="perfect-scroll">
                ...
                <div class="site-copyright color-grey-400 mt-0">
                    <div class="box-download-app">
                        <p class="font-xs color-grey-900 mb-25">Download our Apps and get extra 15% Discount on
                            your first Order…!
                        </p>
                        <div class="mb-25">
                            <div class="d-flex"><a class="mr-10" href="#"><img
                                        src="assets/imgs/template/appstore-btn.png" alt="DML Express"></a><a
                                    href="#"><img src="assets/imgs/template/google-play-btn.png"
                                        alt="DML Express"></a>
                            </div>
                        </div>
                    </div>
                    <div class="mb-0"><span class="font-xs color-grey-500">© DML Official 2024. All right
                            reversed.</span>
                    </div>
                </div>
            </div>
