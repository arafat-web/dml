    ...
    @if ($bookingService === 'DPD' && isset($result['data']))
        <section style="max-width: 1000px; margin: 0 auto" class="section d-block">
            <div class="container">
                <div class="card shadow-lg border-0 mb-4">
                    <div class="card-header bg-brand-1 text-white text-center">
                        <h5 class="mb-0" style="font-size: 1.5rem; font-weight: 600; color: #034460">DPD Tracking Details
                        </h5>
                    </div>
                    <div class="card-body p-4">
                        <div class="table-responsive">
        ...
        <section style="max-width: 1000px; margin: 0 auto" class="section d-block">
            <div class="container">
                <div class="card shadow-lg border-0 mb-4">
                    <div class="card-header bg-brand-1 text-white text-center">
                        <h5 class="mb-0" style="font-size: 1.5rem; font-weight: 600; color: #034460">
                            FedEx Tracking Details for {{ $result['output']['completeTrackResults'][0]['trackingNumber'] }}
                        </h5>
                    </div>
                    <div class="card-body p-4">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <p><strong>Status:</strong>
                                    {{ $result['output']['completeTrackResults'][0]['trackResults'][0]['latestStatusDetail']['statusByLocale'] ?? 'N/A' }}
                                </p>
                                <p><strong>Picked Up:</strong>
                                    {{ \Carbon\Carbon::parse($result['output']['completeTrackResults'][0]['trackResults'][0]['dateAndTimes'][1]['dateTime'] ?? '')->diffForHumans() }}
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p><strong>Shipped From:</strong>
                                    {{ $result['output']['completeTrackResults'][0]['trackResults'][0]['shipperInformation']['address']['city'] ?? 'N/A' }},
                                    {{ $result['output']['completeTrackResults'][0]['trackResults'][0]['shipperInformation']['address']['stateOrProvinceCode'] ?? 'N/A' }}
                                </p>
                                <p><strong>Destination:</strong>
                                    {{ $result['output']['completeTrackResults'][0]['trackResults'][0]['recipientInformation']['address']['city'] ?? 'N/A' }},
                                    {{ $result['output']['completeTrackResults'][0]['trackResults'][0]['recipientInformation']['address']['stateOrProvinceCode'] ?? 'N/A' }}
                                </p>
                            </div>
                        </div>
